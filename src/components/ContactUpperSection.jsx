  ...
  return (
    <>
      <div className="flex flex-col md:flex-row lg:flex-row">
        <div className="left-side flex pl-4 pt-5 md:pl-14 md:pt-14 lg:pl-14 pt:14 ">
          <div>
        ...
        <div className="right-side">
          <div>
            ...
            >
              <div className="flex flex-wrap justify-center items-center md:pt-14 md:pl-14 lg:pt-14 lg:pl-14 md:mt-10 lg:mt-10 ">
